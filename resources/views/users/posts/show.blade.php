            ...
            <div class="card border-0">
                    ...
                    <div class="row align-items-center">
                        <div class="col-auto">
                            <a href="{{ route('profile.show', $post->user->id) }}">
                                @if ($post->user->avatar)
                                    <img src="{{ $post->user->avatar }}" alt="User ID {{ $post->user->id }}" class="rounded-circle avatar-sm">
                                @else
                ...
                <div class="card-body w-100">
                    ...
                    {{--
                        ...
                        strtotime('2024-05-10 03:11:19') --> 1715684832 unix

                        date('M d, Y', 1715684832)
                    --}}
                    ...
                    <div class="mt-4">
                        <form action="{{ route('comment.store', $post->id) }}" method="post">
                            ...
                            <div class="input-group">
                                ...
                                <button type="submit" class="btn btn-outline-secondary btn-sm"><i class="fa-solid fa-paper-plane"></i></button>
                            </div>
